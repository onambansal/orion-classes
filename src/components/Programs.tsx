      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {siteData.programs.map((program, index) => {
            ...
            return (
              <div
                key={program.title}
                className={`bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 border ${colors.border} flex flex-col`}
              >
                <div
        ...
        <div className="mt-14 text-center">
          ...
          <p className="mt-3 text-sm text-gray-500">
            No commitment required — try a class first!
          </p>
        </div>
